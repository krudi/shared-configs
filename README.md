...
| [@krudi/stylelint-config](https://www.npmjs.com/package/@krudi/stylelint-config)   | Shared [Stylelint](https://github.com/stylelint/stylelint) configuration   | ![NPM Version](https://img.shields.io/npm/v/@krudi/stylelint-config)  | ![NPM Downloads](https://img.shields.io/npm/dm/@krudi/stylelint-config) ![NPM License](https://img.shields.io/npm/l/@krudi/stylelint-config)   |
