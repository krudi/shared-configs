...
name: retrospective
description:
    Capture lessons learned after a session. Use when the user corrects your work, after surprises, or at the end of a
    substantial session. Updates .ai/memory/lessons.md.
---
